...
from flask import request, jsonify, _request_ctx_stack, Response, session
...
if ENV_FILE:
    load_dotenv(ENV_FILE)
AUTH0_DOMAIN = 'dev-qpbyq27l.us.auth0.com'
API_IDENTIFIER = 'https://task-management.com/api'
ALGORITHMS = ["RS256"]
...
def get_token_auth_header() -> str:
    ...
    if not auth:
        auth = 'Bearer ' + session.get('user')['id_token']
    if not auth:
